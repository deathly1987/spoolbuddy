...
The SpoolBuddy team takes security seriously. We appreciate your efforts to responsibly disclose your findings.
...
- **Affected versions** of SpoolBuddy
...
SpoolBuddy communicates with your printers over your local network using:
...
The SpoolBuddy hardware device:

- Connects to your WiFi network
- Communicates only with the backend server
- Does not expose any ports directly

### Recommendations

1. **Run on trusted network**: SpoolBuddy should only be accessible on your local network
...
- Issues requiring physical access to the device or server
...
Thank you for helping keep SpoolBuddy and its users safe!
